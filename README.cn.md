...
[![x-cmd/install — numbat Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/numbat.svg?lang=zh)](https://x-cmd.com/install/numbat)
...
合计: **31,374** 行代码（覆盖前 5 种语言、共 **109** 个文件）。
...
- **上游仓库**: <https://github.com/sharkdp/numbat>
- **官网**: <https://numbat.dev>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v1.24.0` (2026-08-23)
- **最近提交**: 2026-08-25
- **Release 含资产**: 21 个

## 流行度

- **Star**: 2,694 · **Fork**: 115 · **开放 issue**: 430 · **贡献者**: 49

## 累计统计

- **发布数**: 23 · **已合并 PR**: 362 · **开放 PR**: 43 · **已关闭 issue**: 343 · **开放 issue**: 87 · **提交数**: 2208

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 0 | 0 | 23 | 0 | 0 | 0 |
| last60d | 2026-07-27 | 1 | 4 | 25 | 2 | 0 | 8 |
| 90d | 2026-06-27 | 1 | 6 | 25 | 5 | 0 | 10 |
| last180d | 2026-03-29 | 1 | 7 | 27 | 7 | 4 | 12 |
| 360d | 2025-09-30 | 8 | 62 | 34 | 26 | 12 | 191 |
| last720d | 2024-10-05 | 11 | 133 | 38 | 69 | 32 | 460 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/numbat.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:36:31Z._
